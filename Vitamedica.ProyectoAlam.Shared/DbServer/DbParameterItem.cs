...
namespace Vitamedica.ProyectoAlam.Shared.DbServer
{
    public class DbParameterItem
    {
        ...
        public DbParameterItem(string parameterName, ParameterDirection parameterDirection, int size, DbType dbType)
        {
            ParameterNameSP = parameterName;
            ParameterDirection = parameterDirection;
            Size = size;
        ...
        public DbParameterItem(string parameterName, DbType dbType, int size, object value)
        {
            ParameterNameSP = parameterName;
            Value = value;
            Size = size;
