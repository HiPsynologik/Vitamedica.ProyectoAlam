...
using Vitamedica.ProyectoAlam.UI.Models;
using Vitamedica.ProyectoAlam.UI.Providers;
using Vitamedica.ProyectoAlam.UI.Results;

namespace Vitamedica.ProyectoAlam.UI.Controllers
{
    [Authorize]
